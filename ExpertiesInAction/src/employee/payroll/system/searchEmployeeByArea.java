...
public class searchEmployeeByArea extends javax.swing.JFrame 
{
    Connection conn=null;
    ResultSet rs=null;
    PreparedStatement pst=null;
    
    public searchEmployeeByArea() 
    {
        initComponents();
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try{
            ...
            String sql = "select id, first_name, surname, job_title, Status, Telephone, Email, Address, Address2 from Staff_information where Address=?";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new searchEmployeeByArea().setVisible(true);
        });
    }
