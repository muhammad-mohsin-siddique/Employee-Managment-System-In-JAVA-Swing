...
public class searchEmployeeByJobTitle extends javax.swing.JFrame 
{
    Connection conn=null;
    ResultSet rs=null;
    PreparedStatement pst=null;
    
    public searchEmployeeByJobTitle() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Results", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Adobe Arabic", 1, 14))); // NOI18N
        ...
        tbl_3.getAccessibleContext().setAccessibleName("");
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try{
            ...
            String sql = "select id, first_name, surname, job_title, Status, Telephone, Email, Address, Address2 from Staff_information where job_title=?";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new searchEmployeeByJobTitle().setVisible(true);
        });
    }
